                                        ...
                                        <div className="col-4">
                                            <div className="form-check card-radio dark">
                                                ...
                                                <label className="form-check-label p-0 avatar-md w-100 bg-dark" htmlFor="layout-mode-dark">
                                                    <span className="d-flex gap-1 h-100">
                                                        <span className="flex-shrink-0">
                                                            <span className="bg-light-subtle d-flex h-100 flex-column gap-1 p-1">
                                                        ...
                                                        <span className="flex-grow-1">
                                                            <span className="d-flex h-100 flex-column">
                                                                <span className="bg-light-subtle d-block p-1"></span>
                                                                <span className="bg-light-subtle d-block p-1 mt-auto"></span>
                                                            </span>
                                                        </span>
                                                    </span>
                                                </label>
