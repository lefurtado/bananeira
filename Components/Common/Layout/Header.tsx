...
const Header = () => {
  ...
  const [actualLayout, setActualLayout] = useState(LAYOUT_MODE_TYPES.LIGHTMODE);

  const toggleLayoutMode = () => {
    const newLayoutMode = actualLayout === LAYOUT_MODE_TYPES.LIGHTMODE
    ? LAYOUT_MODE_TYPES.DARKMODE
    : LAYOUT_MODE_TYPES.LIGHTMODE

    setActualLayout(newLayoutMode);

    dispatch(changeLayoutMode(newLayoutMode));
  }
            ...
            <div className="d-flex align-items-center">
              ...
              {/* <Dropdown className="topbar-head-dropdown ms-1 header-item">
                ...
                <Dropdown.Menu className="p-2 dropdown-menu-end" id="light-dark-mode">
                  <Dropdown.Item href="#" data-mode="light" onClick={() => dispatch(changeLayoutMode(LAYOUT_MODE_TYPES.LIGHTMODE))}><i className="bi bi-sun align-middle me-2"></i> Padrão (Claro)</Dropdown.Item>
                  <Dropdown.Item href="#" data-mode="dark" onClick={() => dispatch(changeLayoutMode(LAYOUT_MODE_TYPES.DARKMODE))}><i className="bi bi-moon align-middle me-2"></i> Escuro</Dropdown.Item>
                  <Dropdown.Item href="#" data-mode="auto" onClick={() => dispatch(changeLayoutMode(LAYOUT_MODE_TYPES.LIGHTMODE))}><i className="bi bi-moon-stars align-middle me-2"></i> Auto (Padrão do Sistema)</Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown> */}
